...
class GestosMano:
    def __init__(self, hand_landmarks) -> None:
        ...
        self.hand_points = [self.hand_landmarks[i] for i in range(21)]
    ...
    def dedo_pulgar_extendido(self) -> bool:
        ...
        """
        angulo = fnl.angle_landmarks(
            self.get_point(2), self.get_point(3), self.get_point(4)
        )
    ...
    def dedo_indice_extendido(self) -> bool:
        ...
        Returns:
            bool: True si el dedo está extendido, False si está recogido.
        """
        angulo_indice = fnl.angle_landmarks(
            self.get_point(8), self.get_point(6), self.get_point(5)
        )
        ...
        return (
            dist_point8_point0 > dist_point7_point0
            or dist_point7_point0 > dist_point6_point0
        ) and angulo_indice > 110
    ...
    def dedo_corazon_extendido(self) -> bool:
        ...
        Returns:
            bool: True si el dedo está extendido, False si está recogido.
        """
        angulo_corazon = fnl.angle_landmarks(
            self.get_point(12), self.get_point(10), self.get_point(9)
        )
        ...
        return (
            dist_point12_point0 > dist_point11_point0
            or dist_point11_point0 > dist_point10_point0
        ) and angulo_corazon > 110
    ...
    def dedo_anular_extendido(self) -> bool:
        ...
        Returns:
            bool: True si el dedo está extendido, False si está recogido.
        """
        angulo_anular = fnl.angle_landmarks(
            self.get_point(16), self.get_point(14), self.get_point(13)
        )
        ...
        return (
            dist_point16_point0 > dist_point15_point0
            or dist_point15_point0 > dist_point14_point0
        ) and angulo_anular > 110
    ...
    def dedo_menique_extendido(self) -> bool:
        ...
        Returns:
            bool: True si el dedo está extendido, False si está recogido.
        """
        angulo_menique = fnl.angle_landmarks(
            self.get_point(20), self.get_point(18), self.get_point(17)
        )
        ...
        return (
            dist_point20_point0 > dist_point19_point0
            or dist_point19_point0 > dist_point18_point0
        ) and angulo_menique > 110
    ...
    def like_pulgar(self) -> bool:
        ...
        angle_points_4_0_5 = fnl.angle_landmarks(
            self.get_point(4), self.get_point(0), self.get_point(5)
        )

        return (
            self.get_point(4).y < self.get_point(5).y
            and angle_points_4_0_5 > 16
            and dedos_correctos
        )
